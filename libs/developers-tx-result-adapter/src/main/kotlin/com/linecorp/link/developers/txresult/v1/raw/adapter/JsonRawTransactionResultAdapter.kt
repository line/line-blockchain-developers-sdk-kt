...
class JsonRawTransactionResultAdapter : TxResultAdapter<String, RawTransactionResult> {
    private val objectMapper = jacksonObjectMapper()

    override fun adapt(input: String): RawTransactionResult {
        val typeReference = object : TypeReference<RawTransactionResult>() {}
